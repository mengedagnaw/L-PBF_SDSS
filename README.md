# MTEX/MATLAB scripts and exported texture figures for EBSD-based orientation distribution function (ODF) analysis of Laser Powder Bed Fusion (LPBF) Super Duplex Stainless Steel (SDSS) 2507 with 3% Nickel(Ni) modified.
